...
function renderTable(data) {
  ...
  data.forEach((post) => {
    ...
    // Bắt sự kiện click để mở modal chi tiết
    row.onclick = function () {
      modalTitle.textContent = post.title;
      modalImage.src = post.image || "https://via.placeholder.com/400x200";
      modalContent.textContent = post.content || "Không có nội dung";
